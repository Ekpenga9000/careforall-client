          ...
          <h2 className='ceo__title'>Meet the CEO</h2>
            <div className='ceo__container'>
              <div className='ceo__div'>
                    ...
                    Our CEO, Dr. John Doe, is a visionary leader with a passion for improving the lives of individuals with disabilities. He is committed to providing comprehensive and accessible healthcare solutions, enhancing the quality of life for people with disabilities through innovative and person-centered care, promoting independence, dignity, and holistic wellness.
                    </p>
                </div>
